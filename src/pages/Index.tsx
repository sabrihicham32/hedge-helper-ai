...
import { Bot, Trash2, TrendingUp, Shield, BarChart3, Rocket, MessageSquare, FileText } from "lucide-react";
...
const Index = () => {
  ...
  const [activeTab, setActiveTab] = useState<"chat" | "sales">("chat");
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex items-center justify-between px-6 py-3 border-b border-border bg-card/50">
          <div className="flex items-center gap-4">
            ...
            {/* Tab Navigation */}
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "chat" | "sales")} className="ml-6">
              <TabsList className="bg-secondary/50">
                ...
                <TabsTrigger value="sales" className="gap-2 data-[state=active]:bg-accent data-[state=active]:text-accent-foreground">
      ...
      {/* Market Data Panel - Hidden on mobile, only show for chat tab */}
      {activeTab === "chat" && (
